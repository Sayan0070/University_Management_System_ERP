...
<?php
    if(isset($_POST['confirm'])){
        ...
        if($_POST['confirm']=='Confirm'){
            ...
            $sql2 = "DELETE FROM `admin` WHERE `UserName` = '".$_POST['UserName']."' and AccountType='Account'";
...
?>
    ...
    <div class="d-flex justify-content-between bg-dark p-1" style="color:white;">
        ...
        <div class="col-8 d-flex align-items-center justify-content-evenly">
            <h1>Delete Accountant Details</h1>
        </div>
    ...
    <ul class="nav nav-pills flex-column mb-auto">
      ...
      <li>
        <a href="/DeleteAccountant.php" class="nav-link active">
  ...
  <?php
    if(isset($_POST["UserName"])){
        if($_POST["UserName"]=='' or $_POST["Password"]==''){
            echo '<form action="DeleteAccountant.php" method="post">
          ...
          while($row2 = $res2->fetch_array()){
            echo ' 
            <form action="DeleteAccountant.php" method="post">
                <div class="d-flex flex-column flex-shrink-0 m-2 p-3 bg-light " style="width: 1000px;">
                    <h5>Enter Account Details</h5>
                    <div class="row m-2">
                        <div class="col">
