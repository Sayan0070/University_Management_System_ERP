...
<?php
    ...
    if(isset($_POST['confirm'])){
        if($_POST['confirm']=='Confirm'){
            ...
            $sql = "DELETE FROM `teachers` WHERE username='".$_POST['username']."'";
...
?>
    ...
    <ul class="nav nav-pills flex-column mb-auto">
      ...
      <li class="nav-item">
        <a href="/DeleteTeacher.php" class="nav-link active" aria-current="page">
    ...
    <form action="DeleteTeacher.php" method="post">
        <div class="d-flex flex-column flex-shrink-0 m-2 p-3 bg-light " style="width: 1000px;">
            ...
            <div class="row m-2">
                ...
                <div class="col">
                    <input type="text" name="brunch" value="'.$row2['branch'].'" readonly="readonly" class="form-control" placeholder="Brunch">
                </div>
            </div>
            <div class="row m-2">
                <div class="col">
            ...
            <div class="row m-2">
                ...
                <div class="col">
                    <input type="date" name="10thPasingYear" value="'.$row2['10thPasingYear'].'" readonly="readonly" class="form-control" placeholder="10th passing year">
                </div>
            </div>
            ...
            <div class="row m-2">
                ...
                <div class="col">
                    <input type="date" name="12thPassingYear" value="'.$row2['12thPassingYear'].'" readonly="readonly" class="form-control" placeholder="12th passing year">
                </div>
            </div>
            <div class="row m-2">
                <div class="col"><h6>Bachlors Details</h6></div>
                <div class="col">
                    <input type="text" name="BachelorCollegeName" value="'.$row2['BachelorCollegeName'].'" readonly="readonly" class="form-control" placeholder="12th School Name">
                </div>
                <div class="col">
                    <input type="number" name="BachelorCollegeMarks" value="'.$row2['BachelorCollegeMarks'].'" readonly="readonly" class="form-control" placeholder="12th Marks">
                </div>
                <div class="col">
                    <input type="date" name="BachelorPassingYear" value="'.$row2['BachelorPassingYear'].'" readonly="readonly" class="form-control" placeholder="12th passing year">
                </div>
            </div>
            <div class="row m-2">
                <div class="col"><h6>Masters Details</h6></div>
                <div class="col">
                    <input type="text" name="MastersCollegesName" value="'.$row2['MastersCollegesName'].'" readonly="readonly" class="form-control" placeholder="12th School Name">
                </div>
                <div class="col">
                    <input type="number" name="MastersCollegesMarks" value="'.$row2['MastersCollegesMarks'].'" readonly="readonly" class="form-control" placeholder="12th Marks">
                </div>
                <div class="col">
                    <input type="date" name="MastersPassingYear" value="'.$row2['MastersPassingYear'].'" readonly="readonly" class="form-control" placeholder="12th passing year">
                </div>
            </div>
            <hr>
            ...
            <div class="row">
                <div class="col">
                    <input type="text" name="branch" value="'.$row2['branch'].'" readonly="readonly" class="form-control" placeholder="Branch">
                </div>
                <div class="col">
                    <input type="text" name="department" value="'.$row2['department'].'" readonly="readonly" class="form-control" placeholder="Department">
                </div>
                <div class="col">
                    <input type="date" name="DOJ" value="'.$row2['DOJ'].'" readonly="readonly" class="form-control" placeholder="Date of joining">
                </div>
            </div>
            <hr>
