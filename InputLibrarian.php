...
<?php
    if(isset($_POST['confirm'])){
        ...
        if($_POST['confirm']=='Confirm'){
            ...
            VALUES ('".$_POST['Fname']."','".$_POST['Mname']."','".$_POST['Lname']."','".$_POST['UserName']."','".$_POST['Password']."','Library')";
...
?>
    ...
    <ul class="nav nav-pills flex-column mb-auto">
      ...
      <li>
        <a href="/InputLibrarian.php" class="nav-link active">
    ...
    <form action="InputLibrarian.php" method="post">
