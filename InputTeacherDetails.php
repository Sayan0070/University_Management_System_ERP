...
<?php
    if(isset($_POST['confirm'])){
        if($_POST['confirm']=='Confirm'){
            ...
            `AccountNo`, `IFSC`, `BrunchCode`,`Email`, `Height`, `Weight`, `BloodGroup`, `AadharNo`) 
            ...
            '".$_POST['Email']."','".$_POST['Height']."','".$_POST['Weight']."','".$_POST['BloodGroup']."','".$_POST['AadharNo']."')";
            ...
            '".$_POST['AccountNo']."','".date('m')."','120000','100','100',
            '100','100','120400','100','100','100',
            '0','20','320','119980')";
    ...
    <form action="InputTeacherDetails.php" method="post">
        <div class="d-flex flex-column flex-shrink-0 m-2 p-3 bg-light " style="width: 1000px;">
            ...
            <div class="row m-2">
                ...
                <div class="col">
                    <input type="text" name="BachelorCollegeName" class="form-control" placeholder="Bachelor College Name">
                </div>
                <div class="col">
                    <input type="number" name="BachelorCollegeMarks" class="form-control" placeholder="Bachelor College Marks">
                </div>
                <div class="col">
                    <input type="date" name="BachelorPassingYear" class="form-control" placeholder="Bachelor Passing Year">
                </div>
            </div>
            <div class="row m-2">
                <div class="col"><h6>Masters Details</h6></div>
                <div class="col">
                    <input type="text" name="MastersCollegesName" class="form-control" placeholder="Masters Colleges Name">
                </div>
                <div class="col">
                    <input type="number" name="MastersCollegesMarks" class="form-control" placeholder="Masters Colleges Marks">
                </div>
                <div class="col">
            ...
            <div class="row">
                ...
                <div class="col">
                    <input type="text" name="BrunchCode" class="form-control" placeholder="Branch Code">
                </div>
            </div>
