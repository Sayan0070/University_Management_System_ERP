...
<body>
    ...
    <div class="row d-flex justify-content-between m-2">
        ...
        <div class="col-8 mx-2">
            <div class="col"><b>Swami Vivekananda Institute of Science and Technology</b></div>
            <div class="row d-flex justify-context-reverse">
              <div class="col">+91 9831084446</div>
              <div class="col">info@svist.org</div>
            </div>
        </div>
    </div>
    <?php
    ...
    $sql = "SELECT * FROM teacher_salary where UserName='".$_SESSION['Tusername']."'"; 
