...
<?php
    if(isset($_POST['confirm'])){
        ...
        if($_POST['confirm']=='Confirm'){
            ...
            `LName`='".$_POST['LName']."' WHERE AccountType='Account' 
            and UserName='".$_POST['UserName']."' and Password='".$_POST['Password']."'";
...
?>
    ...
    <ul class="nav nav-pills flex-column mb-auto">
      ...
      <li>
        <a href="/UpdateAccountant.php" class="nav-link active">
  ...
  <?php
    if(isset($_POST["UserName"])){
        if($_POST["UserName"]=='' or $_POST["Password"]==''){
            echo '<form action="UpdateAccountant.php" method="post">
          ...
          $con=mysqli_connect("localhost","root","","authentication");
          $sql2 = "SELECT * FROM admin where AccountType='Account' and UserName='".$_POST['UserName']."' and Password='".$_POST['Password']."'";
