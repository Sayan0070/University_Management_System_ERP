...
<?php
    if(isset($_POST['confirm'])){
        ...
        if($_POST['confirm']=='Confirm'){
            ...
            `LName`='".$_POST['LName']."' WHERE AccountType='Library' 
...
?>
    ...
    <ul class="nav nav-pills flex-column mb-auto">
      ...
      <li>
        <a href="/UpdateLibrarian.php" class="nav-link active">
  ...
  <?php
    if(isset($_POST["UserName"])){
        if($_POST["UserName"]=='' or $_POST["Password"]==''){
            echo '<form action="UpdateLibrarian.php" method="post">
          ...
          while($row2 = $res2->fetch_array()){
            echo ' 
            <form action="UpdateLibrarian.php" method="post">
                <div class="d-flex flex-column flex-shrink-0 m-2 p-3 bg-light " style="width: 1000px;">
                    <h5>Enter Account Details</h5>
                    <div class="row m-2">
                        <div class="col">
