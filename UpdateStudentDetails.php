...
<?php
    if(isset($_POST['confirm'])){
        ...
        if($_POST['confirm']=='Confirm'){
            ...
            $sql = "UPDATE `students` SET `Fname`='".$_POST['Fname']."',`Mname`='".$_POST['Mname']."',
            `Lname`='".$_POST['Lname']."',`DOB`='".$_POST['DOB']."',`10thSchoolName`='".$_POST['10thSchoolName']."',
            `10thSchoolMarks`='".$_POST['10thSchoolMarks']."',`10thSchoolPassingYear`='".$_POST['10thSchoolPassingYear']."',
            `12thSchoolName`='".$_POST['12thSchoolName']."',`12thSchoolMarks`='".$_POST['12thSchoolMarks']."',
            `12thSchoolPassingYear`='".$_POST['12thSchoolPassingYear']."',`VillageOrCity`='".$_POST['VillageOrCity']."',
            `PO`='".$_POST['PO']."',`PS`='".$_POST['PS']."',`Pin`='".$_POST['Pin']."',`Dist`='".$_POST['Dist']."',
            `State`='".$_POST['State']."',`Country`='".$_POST['Country']."',`PhoneNo`='".$_POST['PhoneNo']."',
            `Email`='".$_POST['Email']."',`Brunch`='".$_POST['Brunch']."',`Roll`='".$_POST['Roll']."',`Height`='".$_POST['Height']."',
            `Weight`='".$_POST['Weight']."',`BloodGroup`='".$_POST['BloodGroup']."',`AadharNo`='".$_POST['AadharNo']."',
            `Hosteller`='".$_POST['Hosteller']."',`ParestsName`='".$_POST['ParestsName']."',
            `ParentsPhoneNumber`='".$_POST['ParentsPhoneNumber']."',`Gender`='".$_POST['Gender']."',`BankName`='".$_POST['BankName']."',
            `AccountNo`='".$_POST['AadharNo']."',`IFSC`='".$_POST['IFSC']."',`BrunchCode`='".$_POST['BrunchCode']."',
            `Semester`='1',`Year`='1' WHERE UserName='".$_POST['username']."' and password='".$_POST['password']."'";
            ...
            $sql2 = "UPDATE `admin` SET `FName`='".$_POST['Fname']."',`MName`='".$_POST['Mname']."',
            `LName`='".$_POST['Lname']."' WHERE UserName='".$_POST['username']."' and AccountType='Student'";
...
?>
    ...
    <ul class="nav nav-pills flex-column mb-auto">
      ...
      <li class="nav-item">
        <a href="/MakeTeacherAttendance.php" class="nav-link link-dark" aria-current="page">
      ...
      <li class="nav-item">
        <a href="/UpdateStudentDetails.php" class="nav-link active" aria-current="page">
  ...
  <?php
    ...
    <form action="UpdateStudentDetails.php" method="post">
        <div class="d-flex flex-column flex-shrink-0 m-2 p-3 bg-light " style="width: 1000px;">
            ...
            <div class="row m-2">
                <div class="col d-flex">
                    Date&nbspof&nbspBirth:&nbsp<input type="Date" name="DOB" value="'.$row2['DOB'].'" class="form-control" placeholder="Date Of Birth">
                </div>
                <div class="col">
                ...
                <div class="col">
                    <input type="number" name="PhoneNo" value="'.$row2['PhoneNo'].'" class="form-control" placeholder="PhoneNo">
                </div>
            ...
            <div class="row m-2">
                ...
                <div class="col">
                    <input type="text" name="Brunch" value="'.$row2['Brunch'].'" class="form-control" placeholder="Brunch">
                </div>
                <div class="col">
                    <input type="number" name="Roll" value="'.$row2['Roll'].'" class="form-control" placeholder="Roll">
                </div>
            </div>
            <div class="row m-2">
                <div class="col">
            ...
            <div class="row m-2">
                <div class="col">
                    <select name="Hosteller" class="form-select">
                        <option selected value="'.$row2['Hosteller'].'">'.$row2['Hosteller'].'</option>
                        <option value="YES">YES</option>
                        <option value="NO">NO</option>
                    </select>
                </div>
                <div class="col">
                    <input type="text" name="ParestsName" value="'.$row2['ParestsName'].'"  class="form-control" placeholder="Parests Name">
                </div>
                <div class="col">
                    <input type="number" name="ParentsPhoneNumber" value="'.$row2['ParentsPhoneNumber'].'" class="form-control" placeholder="Parents Phone Number">
                </div>
            </div>
            <div class="row m-2">
                <div class="col">
            ...
            <div class="row m-2">
                ...
                <div class="col">
                    <input type="text" name="10thSchoolMarks" value="'.$row2['10thSchoolMarks'].'"  class="form-control" placeholder="10th Marks">
                </div>
                <div class="col">
                    <input type="date" name="10thSchoolPassingYear" value="'.$row2['10thSchoolPassingYear'].'" class="form-control" placeholder="10th passing year">
                </div>
            </div>
            ...
            <div class="row m-2">
                ...
                <div class="col">
                    <input type="text" name="12thSchoolMarks" value="'.$row2['12thSchoolMarks'].'"  class="form-control" placeholder="12th Marks">
                </div>
                <div class="col">
                    <input type="date" name="12thSchoolPassingYear" value="'.$row2['12thSchoolPassingYear'].'"  class="form-control" placeholder="12th passing year">
                </div>
            </div>
            <hr>
            ...
            <div class="row m-2">
                    ...
                    <div class="col">
                        <input type="text" name="Country" value="'.$row2['VillageOrCity'].'" class="form-control" placeholder="Country">
                    </div>
            </div> 
            <hr>
        ...
        echo '<form action="UpdateStudentDetails.php" method="post">
        <div class="d-flex flex-column flex-shrink-0 m-2 p-3 bg-light " style="width: 1000px;">
            <h5>Enter Account Details</h5>
            <div class="row m-2">
                <div class="col">
