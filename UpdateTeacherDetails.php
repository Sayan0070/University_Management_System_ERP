    ...
    <form action="UpdateTeacherDetails.php" method="post">
        <div class="d-flex flex-column flex-shrink-0 m-2 p-3 bg-light " style="width: 1000px;">
            ...
            <div class="row m-2">
                ...
                <div class="col">
                    <input type="text" name="BachelorCollegeName" value="'.$row2['BachelorCollegeName'].'" class="form-control" placeholder="Bachelor College Name">
                </div>
                <div class="col">
                    <input type="number" name="BachelorCollegeMarks" value="'.$row2['BachelorCollegeMarks'].'" class="form-control" placeholder="Bachelor Marks">
                </div>
                <div class="col">
                    <input type="date" name="BachelorPassingYear" value="'.$row2['BachelorPassingYear'].'" class="form-control" placeholder="Bachelor Passing Year">
                </div>
            </div>
            <div class="row m-2">
