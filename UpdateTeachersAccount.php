...
<?php
    if(isset($_POST['confirm'])){
        if($_POST['confirm']=='Confirm'){
            ...
            $sql = "
            UPDATE `teachers` SET `BankName`='".$_POST['BankName']."',`AccountNo`='".$_POST['AccountNo']."',
...
?>
    ...
    <main style="display:flex; overflow-y: hidden;" >
        ...
        <li class="nav-item">
            <a href="/UpdateTeachersAccount.php" class="nav-link active" aria-current="page">
    ...
    <form action="UpdateTeachersAccount.php" method="post">
