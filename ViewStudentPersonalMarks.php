...
<body>
    ...
    <ul class="nav nav-pills flex-column mb-auto">
      ...
      <li class="nav-item">
        <a href="/ViewStudentPersonalMarks.php" class="nav-link active" aria-current="page">
    ...
    if($res = $con->query($sql)){ 
        ...
        $sql = "SELECT * FROM marks where UserName='".$_SESSION['Susername']."'";
        $res = mysqli_query($con, $sql);
        if($res = $con->query($sql)){ 
        if($res->num_rows > 0){ 
            echo "<table class='table table-striped mt-1'>"; 
                echo "<tr>";
                    ...
                    echo "<th colspan='3' scope='col'>CA1</th>"; 
                    echo "<th colspan='3' scope='col'>CA2</th>";
                    echo "<th colspan='3' scope='col'>CA3</th>"; 
                    echo "<th colspan='3' scope='col'>CA4</th>";
            ...
            while($row = $res->fetch_array()){ 
                echo "<tr>"; 
                    ...
                    echo "<td colspan='3' >" . $row['CA1'] . "</td>"; 
                    echo "<td colspan='3' >" . $row['CA2'] . "</td>";
                    echo "<td colspan='3' >" . $row['CA3'] . "</td>";
                    echo "<td colspan='3' >" . $row['CA4'] . "</td>";
