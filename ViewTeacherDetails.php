...
<body>
    ...
    <ul class="nav nav-pills flex-column mb-auto">
      <li class="nav-item">
        <a href="/ViewTeacherDetails.php" class="nav-link active" aria-current="page">
    ...
    $sql = "SELECT * FROM teachers LIMIT " . $initial_page . ',' . $limit;  
    ...
    if($res = $con->query($sql)){ 
        if($res->num_rows > 0){ 
          ...
          echo "<tr>"; 
              ...
              echo "<th colspan='3' scope='col'>Joining Date </th>"; 
              ...
              echo "<th colspan='3' scope='col'>Bachelor&nbspCollegeName </th>";
              echo "<th colspan='3' scope='col'>Bachelor&nbspCollege&nbspMarks </th>";
              echo "<th colspan='3' scope='col'>Bachelor&nbspCollege&nbspPassing&nbspYear </th>";
              echo "<th colspan='3' scope='col'>Masters&nbspCollege&nbspName </th>";
              echo "<th colspan='3' scope='col'>Masters&nbspCollege&nbspMarks </th>";
              echo "<th colspan='3' scope='col'>Masters&nbspCollege&nbspPassing&nbspYear </th>";
          ...
          // }
            while($row = $res->fetch_array()){ 
                echo "<tr>";
                    ...
                    echo "<td colspan='3' >" . $row['DOJ'] . "</td>";
                    echo "<td colspan='3' >" . $row['10thSchoolName'] . "</td>";
                    echo "<td colspan='3' >" . $row['10thSchoolMarks'] . "</td>";
                    echo "<td colspan='3' >" . $row['10thPasingYear'] . "</td>";
                    echo "<td colspan='3' >" . $row['12thSchoolName'] . "</td>";
                    echo "<td colspan='3' >" . $row['12thSchoolMarks'] . "</td>";
                    echo "<td colspan='3' >" . $row['12thPassingYear'] . "</td>";
                    echo "<td colspan='3' >" . $row['BachelorCollegeName'] . "</td>";
                    echo "<td colspan='3' >" . $row['BachelorCollegeMarks'] . "</td>";
                    echo "<td colspan='3' >" . $row['BachelorPassingYear'] . "</td>";
                    echo "<td colspan='3' >" . $row['MastersCollegesName'] . "</td>";
                    echo "<td colspan='3' >" . $row['MastersCollegesMarks'] . "</td>";
                    echo "<td colspan='3' >" . $row['MastersPassingYear'] . "</td>";
